...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>DETALLADO PARA 22 BARRAS</h2>
          <ul>
            <p></p>
            <li>
            ...
            <p></p>
            <li>
              Estribos superpuestos que abrazan 13 barras longitudinales cada
              uno con dobleces a 135°.
            </li>
            <p></p>
            <li>
              Estribos superpuestos que abrazan 14 barras longitudinales cada
              uno con dobleces a 135°
            </li>
          </ul>
        </SpecificationPanel>
