...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>DETALLADO PARA 16 BARRAS DE 10 RAMAS</h2>
          <ul>
            <p></p>
            <li>
            ...
            <p></p>
            <li>
              Estribo cerrado que abraza 16 barras longitudinales con dobleces
              a 135°.
            </li>
            <p></p>
            <li>
              Estribos de apoyo posicionados de manera perpendicular que
              envuelve 6 barras longitudinales centrales.
            </li>
            <p></p>
            <li>
              Estribo de apoyo a 45° que envuelve 4 barras longitudinales
              centrales.
            </li>
          </ul>
        </SpecificationPanel>
