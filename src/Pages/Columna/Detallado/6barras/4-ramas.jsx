...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>DETALLADO PARA 6 BARRAS DE 4 RAMAS</h2>
          <ul>
            <li>
            ...
            <li>
              ...
              de espaciamiento libre en el refuerzo paralelo al lado de longitud
              mayor.
            </li>
            <p></p>
            <li>
              En el refuerzo paralelo a la longitud menor la distancia entre
              barras longitudinales puede ser mayor de 150 mm y no se requiere
              elemento de apoyo.
            </li>
            <p></p>
            <li>
              Estribo cerrado que abraza 6 barras longitudinales con doblez a
              135°.
            </li>
          </ul>
        </SpecificationPanel>
        <ThreeDContainer>
          <C_03 width="100%" height="100%" />
        </ThreeDContainer>
      </DetailContainer>
    </>
  );
