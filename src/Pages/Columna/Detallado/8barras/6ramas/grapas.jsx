      ...
      <DetailContainer>
        <SpecificationPanel>
          ...
          <ul>
            ...
            <p></p>
            <li>Estribo único que abraza 8 longitudinales con doblez a 135°</li>
            <p></p>
            <li>
              Grapas suplementarias posicionadas en las barras centrales de
              manera perpendicular con doblez a 135°
            </li>
          </ul>
        </SpecificationPanel>

        <ThreeDContainer>
          <C_08 width="100%" height="100%" />
        </ThreeDContainer>
      </DetailContainer>
    </>
  );
