      ...
      <DetailContainer>
        <SpecificationPanel>
          ...
          <ul>
            <p></p>
            <li>
              La posición de los ganchos debe alternarse en estribos consecutivos.
            ...
            <p></p>
            <li>Estribo cerrado único que abraza 12 barras longitudinales con doblez a 135°. 
            </li>
            <p></p>
            <li>
            Grapas suplementarias posicionadas de manera perpendicular al centro del elemento con doblez a 135°
            </li>
          </ul>
        </SpecificationPanel>

        <ThreeDContainer>
          <C_13 width="100%" height="100%" />
        </ThreeDContainer>
      </DetailContainer>
    </>
  );
