...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>ESQUINA SIMPLE</h2>
          <ul>
            <p></p>
            <li>
              Refuerzo perimetral compuesto en muro largo, barras interior con dobleces a 90° y 135°.
            </li>
            <p></p>
            <li>
              Estribo cerrado de apoyo con doblez a 135° en el muro corto
            </li>
            <p></p>
            <li>
