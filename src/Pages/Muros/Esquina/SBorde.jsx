...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>ESQUINA SIN ELEMENTO DE BORDE </h2>
          <ul>
            <p></p>
            <li>
            ...
            <p></p>
            <li>
              Refuerzo horizontal que termine en muros sin elemento de borde deberá proporcionarse con dobleces estándar que abracen el refuerzo vertical en las orillas.
