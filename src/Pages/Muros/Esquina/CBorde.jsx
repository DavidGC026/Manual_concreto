...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>ESQUINA CON ELEMENTO DE BORDE </h2>
          <ul>
            <p></p>
            <li>
              Refuerzo en alma, estribo compuesto con dobleces a 90° y 135° con grapas suplementarias a 135.

            </li>
            <p></p>
            <li>
              Estribos cerrados perpendicularmente con doblez a 135° en la conexión de muro.
