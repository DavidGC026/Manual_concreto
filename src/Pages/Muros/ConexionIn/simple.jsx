...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>CONEXIÓN INTERIOR CON PATIN</h2>
          <ul>
            <p></p>
            <li>
              Elemento de borde requerido pero no se requieren estribos sobrepuestos.

            </li>
            <p></p>
            <li>
              Estribos cerrados que abrazan el área de conexión perpendicularmente con dobleces y grapas suplementarias a 135°

            </li>
            <p></p>
            <li>
              Acero longitudinal recto en el muro de borde con grapas suplementarias con doblez a 135°

            </li>
            <p></p>
            <li>
              Acero longitudinal en muro interior con doblez a 90° y grapas suplementarias a 135°
