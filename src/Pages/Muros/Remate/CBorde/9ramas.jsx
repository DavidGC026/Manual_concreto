...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>Remate Con elemento de Borde 9 ramas </h2>
          <ul>
            <p></p>
            <li>
              Estribos sobre puestos que abrazan 9 varillas cada uno con grapas de 135° suplementarios

            </li>
            <p></p>
            <li>
              Grapas de 135° soportando el refuerzo horizontal longitudinal distribuido del alma con doblez a 90° en el alma.
