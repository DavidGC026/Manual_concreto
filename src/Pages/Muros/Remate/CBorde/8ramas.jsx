...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>Remate Con elemento de Borde 8 ramas</h2>
          <ul>
            <p></p>
            <li>
              Estribo cerrado de confinamiento del perímetro grapas suplementarios de 135°

            </li>
            <p></p>
            <li>
              Grapas suplementarias de 135° apoyando lateralmente el refuerzo distribuido en el alma.

            </li>
            <p></p>
            <li>
              Varilla horizontal con doblez a 90° en el alma.
