...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>CONEXION DE VIGAS</h2>
          <ul>
            <p></p>
            <li>
              Estribos cerrados en viga principal con dobleces a 135°
            </li>
            <p></p>
            <li>2 varillas de acero longitudinal en lecho superior</li>
            <p></p>
            <li>4 varillas de acero longitudinal en lecho inferior.</li>
          </ul>
        </SpecificationPanel>

        <ThreeDContainer>
          <V_1 width="100%" height="100%" />
        </ThreeDContainer>
      </DetailContainer>
    </>
  );
