      ...
      <DetailContainer>
        <SpecificationPanel>
          ...
          <ul>
            ...
            <p></p>
            <li>
              2 varillas de acero longitudinal en lecho superior
            </li>
            <p></p>
            <li>
              3 varillas de acero longitudinal en lecho inferior
            </li>
            <p></p>
            <li>
              Traslapo en elemento de apoyo
            </li>
            <p></p>
            <li>
              El refuerzo longitudinal termina con un gancho estándar orientado hacia la mitad de la altura de la viga o columna.
            </li>
          </ul>
        </SpecificationPanel>

        <ThreeDContainer>
          <V_4 width="100%" height="100%" />
        </ThreeDContainer>
      </DetailContainer>
    </>
  );
