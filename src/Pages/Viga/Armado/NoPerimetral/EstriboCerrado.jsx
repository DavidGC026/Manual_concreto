...
export default function DetalleBarras() {
  return (
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          <h2>ESTRIBO CERRADO</h2>
          <ul>
            <p></p>
            <li>
              Estribos cerrados con dobleces a 135°
            </li>
            <p></p>
            <li>
            ...
            <p></p>
            <li>
              5 varillas de acero longitudinal en lecho inferior
            </li>
            <p></p>
            <li>
              El refuerzo longitudinal del lecho superior 
              termina con un gancho estándar orientado 
              hacia la mitad de la altura de la viga o columna.
            </li>
          </ul>
        </SpecificationPanel>
        <ThreeDContainer>
          <V_3 width="100%" height="100%" />
        </ThreeDContainer>
      </DetailContainer>
    </>
  );
