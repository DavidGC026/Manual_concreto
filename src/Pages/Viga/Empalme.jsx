    ...
    <>
      ...
      <DetailContainer>
        <SpecificationPanel>
          ...
          <ul>
            <p></p>
            <li>Estribos cerrados en Trabe principal con dobleces a 135°.
            </li>
            <p></p>
            <li>2 varillas de acero longitudinal en lecho superior
            </li>
            <p></p>
            <li>4 varillas de acero longitudinal en lecho inferior
            </li>
            <p></p>
            <li>La longitud de desarrollo de la barra debe cumplir con lo establecido en el punto 6.3 del manual de concreto reforzado del IMCYC. 
            </li>
          </ul>
        </SpecificationPanel>

        <ThreeDContainer>
          <V_2 width="100%" height="100%" />
        </ThreeDContainer>
      </DetailContainer>
    </>
  );
