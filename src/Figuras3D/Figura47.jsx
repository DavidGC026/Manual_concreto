...
const ThreeScene = () => {
    ...
    useEffect(() => {
        ...
        const GrapasNaranjas2 = [
            new THREE.Vector3(-2.7, 0, -3.9),
            new THREE.Vector3(-2.45, 0, -4.45),
            new THREE.Vector3(-2.45, 0, -4.6),
            new THREE.Vector3(-4.25, 0, -4.6),
            new THREE.Vector3(-4.35, 0, -4.6),
            new THREE.Vector3(-4.45, 0, -4.6),
            new THREE.Vector3(-4.45, 0, -3.9),
            new THREE.Vector3(-4.45, 0, -2.3),
            new THREE.Vector3(-4.45, 0, -2.2),
            new THREE.Vector3(-4.45, 0, 0.2),
            new THREE.Vector3(-4.45, 0, 0.3),
            new THREE.Vector3(-4.45, 0, 2.2),
            new THREE.Vector3(-4.45, 0, 2.3),
            new THREE.Vector3(-4.45, 0, 4.9),
            new THREE.Vector3(-4.45, 0, 5),
            new THREE.Vector3(-4.45, 0, 5.1),
            new THREE.Vector3(-4.45, 0, 7.75),
            new THREE.Vector3(-4.45, 0, 8.75),
            new THREE.Vector3(-4.45, 0, 9),
        ];
        for (let i = 0; i < 4; i++) {
            createMeshLineEstribos(
                GrapasNaranjas2,
        ...
        const EstribosAzules = [
            new THREE.Vector3(-4.6, 0, -3.9),
            new THREE.Vector3(-4.9, 0, -4.45),
            new THREE.Vector3(-4.9, 0, -4.6),
            new THREE.Vector3(-4.8, 0, -4.6),
            new THREE.Vector3(-1.35, 0, -4.6),
            new THREE.Vector3(-1.30, 0, -4.6),
            new THREE.Vector3(-1.25, 0, -4.6),

            new THREE.Vector3(-1, 0, -4.6),
            new THREE.Vector3(-1, 0, -4.5),
            new THREE.Vector3(-1, 0, -3.9),
            new THREE.Vector3(-1, 0, -2.60),
            new THREE.Vector3(-1, 0, -2.55),

            new THREE.Vector3(-1.15, 0, -2.55),
            new THREE.Vector3(-1.25, 0, -2.55),
            new THREE.Vector3(-4.8, 0, -2.55),
            new THREE.Vector3(-4.9, 0, -2.55),

            new THREE.Vector3(-4.9, 0.06, -2.6),
            new THREE.Vector3(-4.9, 0.08, -3.9),
            new THREE.Vector3(-4.9, 0.1, -4.6),
            new THREE.Vector3(-4.7, 0.1, -4.6),
            new THREE.Vector3(-4.2, 0.1, -4.1),
        ...
        const EstribosAzules2 = [
            ...
            new THREE.Vector3(-6.6, 0, -1.1),
            new THREE.Vector3(-6.7, 0, -1.1),
            new THREE.Vector3(-8.5, 0, -1.1),

            new THREE.Vector3(-8.6, 0, -1.2),
            new THREE.Vector3(-8.6, 0, -1.3),
            new THREE.Vector3(-8.6, 0, -2.2),
            new THREE.Vector3(-8.6, 0, -2.3),
            new THREE.Vector3(-8.6, 0, -3.1),
            new THREE.Vector3(-8.6, 0, -3.15),

            new THREE.Vector3(-8.5, 0, -3.15),
            new THREE.Vector3(-6.7, 0, -3.15),
            new THREE.Vector3(-6.6, 0, -3.15),
            new THREE.Vector3(-5, 0, -3.15),
            new THREE.Vector3(-4.85, 0, -3.15),

            new THREE.Vector3(-4.65, 0, -3.15),
            new THREE.Vector3(-4.65, 0.02, -3.05),
            new THREE.Vector3(-4.65, 0.02, -2.3),
            new THREE.Vector3(-4.65, 0.04, -2.2),
            new THREE.Vector3(-4.65, 0.06, -1.2),
            new THREE.Vector3(-4.65, 0.08, -1.1),
        ...
        const GrapasVerdes = [
            new THREE.Vector3(-6.4, 0, -4.1),
            new THREE.Vector3(-6.75, 0, -4.5),
            new THREE.Vector3(-6.6, 0, -4.6),
            new THREE.Vector3(-4.95, 0, -4.6),
            new THREE.Vector3(-4.75, 0, -4.6),
            new THREE.Vector3(-4.6, 0, -4.5),
            new THREE.Vector3(-4.9, 0, -4.1),
