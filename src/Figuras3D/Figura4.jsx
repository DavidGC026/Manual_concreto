...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const VarillasAzules = [
      ...
      new THREE.Vector3(1, 0.57, -0.55),
      new THREE.Vector3(1.55, 0.58, -0.55),
      new THREE.Vector3(1.55, 0.59, -0.4),
    ...
    const VarillasAzules2 = [
      ...
      new THREE.Vector3(1.55, 0.5, 0),
      new THREE.Vector3(1.55, 0.5, 0.5),
      new THREE.Vector3(1.55, 0.49, 1),
      new THREE.Vector3(1.55, 0.48, 1.5),
      new THREE.Vector3(1.55, 0.47, 1.55),

      new THREE.Vector3(1, 0.46, 1.55),
      new THREE.Vector3(-0.5, 0.45, 1.55),
      new THREE.Vector3(-1, 0.44, 1.55),
      new THREE.Vector3(-1.5, 0.43, 1.55),
      new THREE.Vector3(-1.55, 0.42, 1.55),
      new THREE.Vector3(-1.55, 0.41, 1.4),
    ...
    const Grapas = [
      ...
      new THREE.Vector3(-0.45, 0.6, -0.55),
      new THREE.Vector3(-0.55, 0.6, -0.55),
      new THREE.Vector3(-0.55, 0.6, -0.5),
      new THREE.Vector3(-0.55, 0.6, 0),
      new THREE.Vector3(-0.55, 0.6, 0.5),
      new THREE.Vector3(-0.55, 0.6, 1.5),
      new THREE.Vector3(-0.55, 0.6, 1.55),
      new THREE.Vector3(-0.45, 0.6, 1.55),
      new THREE.Vector3(-0.3, 0.6, 1.3),
    ];
    for (let i = 0; i < 3; i++) {
      createMeshLineVarillas2(Grapas, 0x39ff14, 0, 0.475, i * 1 - 1, 0);
    }
