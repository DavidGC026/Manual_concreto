...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const VarillasAzules2 = [
      ...
      new THREE.Vector3(1, 0.5, -0.55),
      new THREE.Vector3(1.45, 0.5, -0.55),
      new THREE.Vector3(1.55, 0.5, -0.55),
      ...
      new THREE.Vector3(1.55, 0.5, 0),
      new THREE.Vector3(1.55, 0.5, 0.5),
      new THREE.Vector3(1.55, 0.51, 1),
      new THREE.Vector3(1.55, 0.52, 1.4),
      new THREE.Vector3(1.55, 0.52, 1.5),
      new THREE.Vector3(1.55, 0.53, 1.55),

      new THREE.Vector3(1, 0.54, 1.55),
      new THREE.Vector3(0.9, 0.54, 1.55),
      new THREE.Vector3(-0.5, 0.55, 1.55),
      new THREE.Vector3(-1, 0.56, 1.55),
      new THREE.Vector3(-1.45, 0.57, 1.55),
