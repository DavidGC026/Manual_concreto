...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const rectPointsa2 = [
      new THREE.Vector3(-1.17, 0.5, 1.4),
      new THREE.Vector3(-1.47, 0.5, 1.6),
      ...
      new THREE.Vector3(-0.25, 0.5, 1.57),
      new THREE.Vector3(-0.5, 0.5, 1.57),
      new THREE.Vector3(-1.4, 0.55, 1.57),
      new THREE.Vector3(-1.6, 0.55, 1.57),
      new THREE.Vector3(-1.6, 0.55, 1.47),
      new THREE.Vector3(-1.25, 0.55, 1.22),
    ];
    ...
    const rectPoints = [
      new THREE.Vector3(2.17, 0.5, -1.37),
      new THREE.Vector3(2.47, 0.5, -1.57),
      new THREE.Vector3(2.57, 0.5, -1.57),
      new THREE.Vector3(2.57, 0.5, -1.25),
      new THREE.Vector3(2.57, 0.5, -1),
      new THREE.Vector3(2.57, 0.5, -0.75),
      ...
      new THREE.Vector3(2.55, 0.5, 1.57),
      new THREE.Vector3(2.25, 0.5, 1.57),
      new THREE.Vector3(2, 0.5, 1.57),
      new THREE.Vector3(1.75, 0.5, 1.57),
      new THREE.Vector3(1.5, 0.5, 1.57),
      ...
      new THREE.Vector3(-0.5, 0.5, -1.57),
      new THREE.Vector3(-0.25, 0.5, -1.57),
      new THREE.Vector3(-0, 0.505, -1.57),
      new THREE.Vector3(0.25, 0.51, -1.57),
      new THREE.Vector3(0.5, 0.515, -1.57),
      new THREE.Vector3(0.75, 0.52, -1.57),
      new THREE.Vector3(1, 0.525, -1.57),
      new THREE.Vector3(1.25, 0.53, -1.57),
      new THREE.Vector3(1.5, 0.535, -1.57),
      new THREE.Vector3(1.75, 0.54, -1.57),
      new THREE.Vector3(2, 0.545, -1.57),
      new THREE.Vector3(2.25, 0.55, -1.57),
      new THREE.Vector3(2.6, 0.55, -1.57),
      new THREE.Vector3(2.6, 0.55, -1.47),
      new THREE.Vector3(2.25, 0.55, -1.22),
    ];
    ...
    const rectPointsamarillas2 = [
      new THREE.Vector3(0.8, 0.5, 1.37),
      new THREE.Vector3(0.55, 0.5, 1.565),
      new THREE.Vector3(0.45, 0.5, 1.565),
      new THREE.Vector3(0.45, 0.5, 1.25),
      new THREE.Vector3(0.45, 0.5, 1),
      new THREE.Vector3(0.45, 0.5, 0.75),
      new THREE.Vector3(0.45, 0.5, 0.5),
      ...
      new THREE.Vector3(0.45, 0.5, -1.565),
      new THREE.Vector3(0.55, 0.5, -1.565),
      new THREE.Vector3(0.8, 0.5, -1.3),
    ];

    for (let i = 0; i < 2; i++) {
      createMeshLineVarillas2(rectPointsamarillas2, 0xffdb58, 0, 0, -1.45 + i * 3.2, 0);
    }
    ...
    for (let i = 0; i < 2; i++) {
      createMeshLineVarillas2(rectPointsverdes2, 0x00FF00, 0, 0, -1.4 + i * 3.2, 0);
    }

    for (let i = 0; i < 1; i++) {
      createMeshLineVarillas2(rectPointsverdes2, 0x00FF00, 0, 0, 0.3 + i * 2, 0);
    }
