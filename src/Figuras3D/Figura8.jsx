...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const VarillasAzules2 = [
      ...
      new THREE.Vector3(-1.5, 0.5, 1.55),
      new THREE.Vector3(-1.55, 0.5, 1.55),
      new THREE.Vector3(-1.55, 0.5, 1.4),
    ...
    for (let i = 0; i < 3; i++) {
      createMeshLineVarillas2(Grapas, 0x39ff14, 0, 0, i * 1 - 1, 0);
    }
    ...
    const Grapas2 = [
      ...
      new THREE.Vector3(1.55, 0.6, -0.55),
      new THREE.Vector3(1.55, 0.6, -0.45),
      new THREE.Vector3(1.3, 0.6, -0.3),
    ];
    for (let i = 0; i < 3; i++) {
      createMeshLineVarillas2(Grapas2, 0x39ff14, 0, -1, i * 1 - 1.05, 1);
    }
