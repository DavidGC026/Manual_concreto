...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 2; i++) {
      createCylinderVarillas(VarillasRojas, 0xff0000, 0.175, 6, 0, -i * 4 + 2);
    }
    ...
    const VarillasMoradas = [
      new THREE.Vector3(-6.75, 0, -2.22),
      new THREE.Vector3(-4.8, 0, -2.22),
      new THREE.Vector3(-4.7, 0, -2.22),
      new THREE.Vector3(3, 0, -2.22),
      new THREE.Vector3(4, 0, -2.22),
      new THREE.Vector3(5, 0, -2.22),
      new THREE.Vector3(6, 0, -2.22),
      new THREE.Vector3(6.2, 0, -2.22),
      new THREE.Vector3(6.1, 0, -2.22),
      new THREE.Vector3(6.1, 0, -2.22),
    ];
    for (let j = 0; j < 2; j++) {
      for (let i = 0; i < 3; i++) {
    ...
    const VarillasAmarillas = [
      new THREE.Vector3(-5.4, 0, -1.5),
      new THREE.Vector3(-5.9, 0, -2.175),
