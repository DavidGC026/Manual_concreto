...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const EstribosMorados = [
      ...
      new THREE.Vector3(-2, 0.25, 2.15),
      new THREE.Vector3(-2.2, 0.25, 2.15),
      new THREE.Vector3(-2.2, 0.225, 2),
      new THREE.Vector3(-2.2, 0.2, 1),
      new THREE.Vector3(-2.2, 0.175, 0),
      new THREE.Vector3(-2.2, 0.15, -1),
      new THREE.Vector3(-2.2, 0.125, -2),
      new THREE.Vector3(-2.2, 0.1, -2.2),
      new THREE.Vector3(-2, 0.075, -2.2),
      new THREE.Vector3(-1, 0.05, -2.2),
      new THREE.Vector3(0, 0.025, -2.2),
      ...
      new THREE.Vector3(-2.25, 0, 2),
      new THREE.Vector3(-2.25, 0, 1.9),
    ...
    const EstribosMorados2 = [
      ...
      new THREE.Vector3(6.1, 0.2, -2.2),
      new THREE.Vector3(6.3, 0.2, -2.2),
      new THREE.Vector3(6.3, 0.2, -2),
      new THREE.Vector3(6.3, 0.15, 1),
      new THREE.Vector3(6.3, 0.125, 2),
      new THREE.Vector3(6.3, 0.1, 2.1),

      new THREE.Vector3(6.1, 0.075, 2.2),
      new THREE.Vector3(6, 0.05, 2.2),
      new THREE.Vector3(-1, 0.025, 2.2),
      new THREE.Vector3(-2, 0, 2.2),
      new THREE.Vector3(-2.05, 0, 2.2),
      new THREE.Vector3(-2.1, 0, 2.2),
      new THREE.Vector3(-2.25, 0, 2),

      new THREE.Vector3(-2.2, 0, 2.15),
      ...
      new THREE.Vector3(6.1, 0, -2.2),
      new THREE.Vector3(6.3, 0, -2),
      new THREE.Vector3(5.7, 0, -1.2),
    ];

    for (let i = 0; i < 1; i++) {
      createMeshLineVarillas2(EstribosMorados2, 0xda8ee7, 0, 0, 1 + -i * 5, 0);
    }

    const EstribosAmarillos = [
      new THREE.Vector3(-7, 0, -1.4),
      new THREE.Vector3(-6, 0, -1.4),
      new THREE.Vector3(-4.5, 0, -1.4),
    ...
    const EstribosAmarillos2 = [
      new THREE.Vector3(-7, 0, -3.2),
      new THREE.Vector3(-6, 0, -3.2),
      new THREE.Vector3(-4.5, 0, -3.2),
      new THREE.Vector3(-4, 0, -3.2),
      new THREE.Vector3(-3.5, 0, -3.2),
      new THREE.Vector3(-3.1, 0, -3.2),
    ...
    const GrapasVerdesClaro = [
      ...
      new THREE.Vector3(-6.5, 0, -2.175),
      new THREE.Vector3(-6.2, 0, -2.175),
      new THREE.Vector3(-6.2, 0, -2.075),
      new THREE.Vector3(-6.2, 0, 2.075),
      new THREE.Vector3(-6.2, 0, 2.175),
      new THREE.Vector3(-6.5, 0, 2.175),
      new THREE.Vector3(-7, 0, 1.5),
    ...
    const GrapasVerdesClaro2 = [
      ...
      new THREE.Vector3(-4.7, 0, -3.345),
      new THREE.Vector3(-4.6, 0, -3.345),
      new THREE.Vector3(-3.2, 0, -3.345),
      new THREE.Vector3(-2.7, 0, -3.345),
      new THREE.Vector3(-2.2, 0, -3.345),
      new THREE.Vector3(-2.2, 0, -3.345),
      new THREE.Vector3(-2.2, 0, -3.345),
      new THREE.Vector3(1.2, 0, -3.345),
      new THREE.Vector3(1.7, 0, -3.345),
      new THREE.Vector3(2.2, 0, -3.345),
      new THREE.Vector3(2.7, 0, -3.345),
      new THREE.Vector3(3.2, 0, -3.345),
      new THREE.Vector3(3.8, 0, -3.345),
