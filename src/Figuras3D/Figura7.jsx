...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const Grapas = [
      ...
      new THREE.Vector3(0.1, 0.5, 1),
      new THREE.Vector3(-0.1, 0.5, 1.2),
      new THREE.Vector3(-0.3, 0.51, 1.4),

      new THREE.Vector3(-0.5, 0.52, 1.6),
      new THREE.Vector3(-0.7, 0.53, 1.4),
      new THREE.Vector3(-0.9, 0.54, 1.2),
      new THREE.Vector3(-1.1, 0.55, 1),
      new THREE.Vector3(-1.3, 0.56, 0.8),
      new THREE.Vector3(-1.45, 0.56, 0.7),
      new THREE.Vector3(-1.55, 0.57, 0.6),
      new THREE.Vector3(-1.55, 0.58, 0.45),
      new THREE.Vector3(-1.5, 0.59, 0.425),
      new THREE.Vector3(-1, 0.6, 0.4),
    ];
    for (let i = 0; i < 2; i++) {
      createMeshLineVarillas2(Grapas, 0x39ff14, 0, 0, i * 2 - 0.9, 0);
    }
    ...
    const Grapas2 = [
      ...
      new THREE.Vector3(-0.8, 0.51, -0.3),

      new THREE.Vector3(-0.5, 0.52, -0.6),
      new THREE.Vector3(-0.3, 0.53, -0.4),
      new THREE.Vector3(-0.1, 0.54, -0.2),
      new THREE.Vector3(0.1, 0.55, 0),
      new THREE.Vector3(0.3, 0.56, 0.2),
      new THREE.Vector3(0.5, 0.57, 0.4),
      new THREE.Vector3(0.6, 0.58, 0.5),
      new THREE.Vector3(0.6, 0.59, 0.55),
      new THREE.Vector3(0.1, 0.6, 0.55),
    ];
    for (let i = 0; i < 1; i++) {
      createMeshLineVarillas2(Grapas2, 0x39ff14, 0, 0, i * 1 + 0.1, 0);
    }
