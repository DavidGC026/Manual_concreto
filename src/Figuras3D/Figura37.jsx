...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const EstribosMorados = [
      ...
      new THREE.Vector3(-2, 0.25, 2.2),
      new THREE.Vector3(-2.2, 0.25, 2.2),
      ...
      new THREE.Vector3(-2.2, 0.1, -2.1),
      new THREE.Vector3(-2.2, 0.075, -2.2),
    ...
    const EstribosMorados2 = [
      ...
      new THREE.Vector3(5.3, 0, -1.6),
      new THREE.Vector3(5.9, 0, -2.2),
      new THREE.Vector3(6.2, 0, -2.2),
      new THREE.Vector3(6.2, 0, -2),
      new THREE.Vector3(6.2, 0, 1),
      new THREE.Vector3(6.2, 0, 2),
      ...
      new THREE.Vector3(3, 0.1, -2.2),
      new THREE.Vector3(4, 0.15, -2.2),
      new THREE.Vector3(5, 0.2, -2.2),
      new THREE.Vector3(6.1, 0.25, -2.2),
      new THREE.Vector3(6.2, 0.25, -2.2),
      new THREE.Vector3(6.2, 0.25, -2),
      new THREE.Vector3(5.6, 0.25, -1.4),
    ];
    ...
    const EstribosAmarillos = [
      new THREE.Vector3(-7, 0, -1.45),
      new THREE.Vector3(-6, 0, -1.45),
      new THREE.Vector3(-4.5, 0, -1.45),
      new THREE.Vector3(-4, 0, -1.45),
      new THREE.Vector3(-3.5, 0, -1.45),
      new THREE.Vector3(-3.1, 0, -1.45),
      new THREE.Vector3(-3, 0, -1.45),
    ...
    const GrapasVerdesClaro = [
      ...
      new THREE.Vector3(-6.5, 0, -2.15),
      new THREE.Vector3(-6.2, 0, -2.15),
      new THREE.Vector3(-6.2, 0, -2),
      new THREE.Vector3(-6.2, 0, 2),
      new THREE.Vector3(-6.2, 0, 2.15),
      new THREE.Vector3(-6.5, 0, 2.15),
    ...
    const GrapasVerdesOscuro = [
      new THREE.Vector3(-7, 0, -1.5),
      new THREE.Vector3(-6.5, 0, -2.15),
      new THREE.Vector3(-6.225, 0, -2.15),
      new THREE.Vector3(-6.225, 0, -2),
      new THREE.Vector3(-6.225, 0, 2),
      new THREE.Vector3(-6.225, 0, 2.15),
      new THREE.Vector3(-6.5, 0, 2.15),
      new THREE.Vector3(-7, 0, 1.5),
    ...
    const GrapasVerdesClaro2 = [
      ...
      new THREE.Vector3(-4.7, 0, -3.3),
      new THREE.Vector3(-4.6, 0, -3.3),
      new THREE.Vector3(-3.2, 0, -3.3),
      new THREE.Vector3(-2.7, 0, -3.3),
      new THREE.Vector3(-2.2, 0, -3.3),
      new THREE.Vector3(-2.2, 0, -3.3),
      new THREE.Vector3(-2.2, 0, -3.3),
      new THREE.Vector3(1.2, 0, -3.3),
      new THREE.Vector3(1.7, 0, -3.3),
      new THREE.Vector3(2.2, 0, -3.3),
      new THREE.Vector3(2.7, 0, -3.3),
      new THREE.Vector3(3.2, 0, -3.3),
      new THREE.Vector3(3.7, 0, -3.3),
      new THREE.Vector3(3.7, 0, -3.1),
