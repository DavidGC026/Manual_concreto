...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const rectPointsa2 = [
      ...
      new THREE.Vector3(-0.5, 0.5, 1.57),
      new THREE.Vector3(-0.75, 0.5, 1.57),
      new THREE.Vector3(-1, 0.51, 1.57),
      new THREE.Vector3(-1.25, 0.52, 1.57),
      new THREE.Vector3(-1.6, 0.53, 1.57),
      new THREE.Vector3(-1.6, 0.54, 1.47),
      new THREE.Vector3(-1.25, 0.55, 1.22),
    ];

    for (let i = 0; i < 1; i++) {
      createMeshLineVarillas2(rectPointsa2, 0x0000ff, 0, 1, 0 + i * 2, 0);
    }

    for (let i = 0; i < 2; i++) {
      createMeshLineVarillas2(rectPointsa2, 0xffdb58, 0, 0, -1.5 + i * 3.2, 0);
    }

    // Crear líneas con esquinas curvas
    const rectPoints = [
      new THREE.Vector3(1.17, 0.5, -1.37),
      ...
      new THREE.Vector3(0.25, 0.5, -1.57),
      new THREE.Vector3(0.5, 0.5, -1.57),
      new THREE.Vector3(0.75, 0.51, -1.57),
      new THREE.Vector3(1, 0.52, -1.57),
      new THREE.Vector3(1.25, 0.53, -1.57),
      new THREE.Vector3(1.57, 0.54, -1.57),
      new THREE.Vector3(1.57, 0.54, -1.47),
      new THREE.Vector3(1.22, 0.55, -1.22),
    ];

    for (let i = 0; i < 2; i++) {
      createMeshLineVarillas2(rectPoints, 0x0000ff, 0, 1, -1.6 + i * 3.2, 0);
    }

    for (let i = 0; i < 1; i++) {
      createMeshLineVarillas2(rectPoints, 0xffdb58, 0, 0, 0.1 + i * 2, 0);
    }
    ...
    for (let i = 0; i < 3; i++) {
      createMeshLineVarillas2(rectPointsverdes1, 0x00FF00, 0, 0, -1.4 + i * 1.6, 0);
    }
