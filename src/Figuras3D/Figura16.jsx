...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const rectPointsa2 = [
      new THREE.Vector3(-2.25, 0.5, 2.35),
      new THREE.Vector3(-2.47, 0.5, 2.57),
      ...
      new THREE.Vector3(1.55, 0.5, 2.57),
      ...
      new THREE.Vector3(-2.57, 0.55, 2.47),
      new THREE.Vector3(-2.35, 0.55, 2.25),
    ];
    ...
    const rectPoints = [
      ...
      new THREE.Vector3(-2.55, 0.5, 2.57),
      ...
      new THREE.Vector3(1.47, 0.55, -1.57),
      new THREE.Vector3(1.57, 0.55, -1.57),
      new THREE.Vector3(1.57, 0.55, -1.47),
    ...
    const rectPointsverdes1 = [
      ...
      new THREE.Vector3(2.6, 0.5, 0.45),
      ...
      new THREE.Vector3(2.6, 0.5, 0.5),
      new THREE.Vector3(2.6, 0.5, 0.55),
      new THREE.Vector3(2.2, 0.5, 0.6),
    ];

    for (let i = 0; i < 2; i++) {
      createMeshLineVarillas2(rectPointsverdes1, 0x00ff00, 0, 0, -1.6 + i * 3.2, 0);
    }

    const rectPointsverdes2 = [
      new THREE.Vector3(-1, 0.5, 0.6),
      new THREE.Vector3(-1.6, 0.5, 0.55),
      ...
      new THREE.Vector3(-1.6, 0.5, 0.45),
